...
@section('content')
    ...
    <div class="container mt-3">
        ...
        <form action="{{ route('update.headphones', ['id' => $headphone->id]) }}" method="post" enctype="multipart/form-data" class="max-w-md mx-auto border border-gray-300 p-6 rounded-md">
            @csrf
            @method('PUT')
            ...
            <div class="flex justify-center mb-6">
                <div class="w-1/2">
                    ...
                    <div class="mb-4">
                        ...
                        <textarea class="form-input border w-full p-2" name="price" id="price" required>{{ old('price', $headphone->price) }}</textarea>
                    </div>
