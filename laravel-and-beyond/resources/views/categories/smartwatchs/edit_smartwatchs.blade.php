                ...
                <div class="w-1/2">
                    @if($smartwatch->photo)
                        <div class="text-center">
                            ...
                            <img src="{{ asset('storage/' . $smartwatch->photo) }}" class="card-img-top custom-thumbnail" alt="{{ $smartwatch->title }}">
                        </div>
                    @endif
                </div>
            </div>
            ...
            <div class="flex justify-center mb-6">
                <div class="w-1/2">
                    ...
                    <div class="mb-4">
                        ...
                        <textarea class="form-input border w-full p-2" name="price" id="price" required>{{ old('price', $smartwatch->price) }}</textarea>
                    </div>
